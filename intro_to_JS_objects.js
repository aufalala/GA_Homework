...
//////////////////////////////////////////////////////////////////////
//EX 1 [Name of pokemon number 59]

console.log(pokemon[59-1].name); // number -1 for easier reference
...
//////////////////////////////////////////////////////////////////////
//EX 3 [Add 'difficulty' to game{}]

game.difficulty = "Easy";

//////////////////////////////////////////////////////////////////////
//EX 4 [Pick and add starter to party]

game.party.push(pokemon[4-1]); // I chose Charmander

//////////////////////////////////////////////////////////////////////
//EX 5 [Pick and add 3 pokemons to party]

game.party.push(pokemon[130-1]); // gyrados
game.party.push(pokemon[150-1]); // mewtwo
game.party.push(pokemon[143-1]); // snorlax

//////////////////////////////////////////////////////////////////////
//EX 6 [Complete gyms difficulty less than 3]
...
//////////////////////////////////////////////////////////////////////
//EX 7 [Evolve starter pokemon]

game.party.splice(0, 1, pokemon[game.party[0].number]);
// using .splice() because suggested method. 
// [game.party[0].number] returns the next (pokemon)index after the starter pokemon in 0 index in party

//////////////////////////////////////////////////////////////////////
//EX 8 [Print names of pokemon in party]

for (const partyMember of game.party) {
    console.log(partyMember.name);
}

//////////////////////////////////////////////////////////////////////
//EX 9 [Print all starter pokemon names]

for (const pokeCheck of pokemon) {
    if (pokeCheck.starter) console.log(pokeCheck.name);
}

//////////////////////////////////////////////////////////////////////
//EX 10 [Create catchPokemon method and catch 1 pokemon]
...
game.catchPokemon(pokemon[10-1]); // caught a caterpie

//////////////////////////////////////////////////////////////////////
//EX 11 [Pokeball count decreases after catch and catch 1 pokemon]
...
game.catchPokemon(pokemon[151-1]); // caught a mew

console.log(game.items);

//////////////////////////////////////////////////////////////////////
//EX 12 [Complete gyms difficulty less than 6]
...
//////////////////////////////////////////////////////////////////////
//EX 13 [Tally number of completed and incomplete gyms]
...
//////////////////////////////////////////////////////////////////////
//EX 14 [Create method to count number of pokemon in party]
...
//////////////////////////////////////////////////////////////////////
//EX 15 [Complete gyms difficulty less than 8]
...
//////////////////////////////////////////////////////////////////////
//EX 17 [Sort game.party by HP descending]
...
//////////////////////////////////////////////////////////////////////
//EX 18 [push pokemonObj to collection if party >6]
...
game.catchPokemon(pokemon[144-1]); //caught an articuno

console.log(game.items);

//////////////////////////////////////////////////////////////////////
//EX 19 [catch only if item pokeball > 0]
...
game.catchPokemon = function(pokemonObj) {
    if (game.items[1].quantity > 0){
        ...
        const insufficentPokeballMessage = "You are out of PokeBalls!"
        console.log(insufficentPokeballMessage); 
    return;
    }
}

//////////////////////////////////////////////////////////////////////
//EX 20 [catch pokemon by name and not number, ensuring letter case doesnt interfere, invalid name returns error message]


game.catchPokemon = function(pokemonName) {
    const pokemonObj = pokemon.find((findPokemon) => {
        return findPokemon.name.toLowerCase() === String(pokemonName).toLowerCase();
    });
    let errorMessage = "";
    ...
    if (pokemonObj){
        if (game.items[1].quantity > 0){
            ...
            errorMessage= "You are out of PokeBalls!";
...
//////////////////////////////////////////////////////////////////////
//EX 21 [new object to categorise pokemon data by type]

let pokemonByType = pokemon.reduce((acc, current) => {
